...
class Project(models.Model):
    ...
    current_margin_percentage = fields.Float(string="Current Margin %", compute='_compute_profitability', store=True)
    ...
    future_margin_percentage = fields.Float(string="Future Margin %", compute='_compute_profitability', store=True)
    ...
    expected_margin_percentage = fields.Float(string="Expected Margin %", compute='_compute_profitability', store=True)
    ...
    def _compute_profitability(self):
        for project in self:
            ...
            project.current_margin_percentage = project.current_margin / project.invoiced_revenue if project.invoiced_revenue != 0 else -1
            ...
            project.future_margin_percentage = project.future_margin / project.to_invoice_revenue if project.to_invoice_revenue != 0 else -1
            ...
            print("\n")
            print(project.expected_revenue)
            print(project.expected_margin)
            print("\n")
            project.expected_margin_percentage = project.expected_margin / project.expected_revenue if project.expected_revenue != 0 else -1
