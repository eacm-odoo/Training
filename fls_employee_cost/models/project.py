...
class Project(models.Model):
    ...
    def _get_profitability_items(self, with_action=True):
        ...
        _logger.info("\n")
        _logger.info(revenue_items_from_sol)
        _logger.info(revenue_items_from_invoices)
        ...
        if sale_line_read_group:
            ...
            for res in product_read_group:
                ...
                for product_id, (amount_to_invoice, amount_invoiced, sol_ids) in sols_per_product.items():
                    _logger.info("\n")
                    _logger.info(amount_to_invoice)
                    _logger.info(amount_invoiced)
                    _logger.info(sols_per_product)
                    _logger.info("\n")
