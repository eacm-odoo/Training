...
class Project(models.Model):
    ...
    #         ['product_id', 'ids:array_agg(id)', 'currency_id:array_agg(currency_id)', 'untaxed_amount_to_invoice', 'untaxed_amount_invoiced'],
    #         ['product_id'],
    #     )
    ...
    #                 res['untaxed_amount_invoiced']*currency_conversion_rate,
    #                 res['ids'],
    #             )
    #         ##### CUSTOM CODE END #####
